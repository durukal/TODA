...
//draw_sprite(s_hp_portarit, 0, -50, -65)
...
var xx = gw - 92;
var yy = 2;
draw_sprite(s_civilian_count, 0, xx, yy);

//draw civilians freed
if room= rm_town{
	
	var text_xx = 7;
	var text_yy = 22;
	draw_set_color(_col);
	draw_text(xx + text_xx + 1, yy + text_yy + 1, o_game.civilians_freed);

	//draw_text(xx + text_xx, yy + text_yy, o_game.civilians_freed);

	//seperator
	draw_set_color(_col);
	draw_text(xx + text_xx + 8, yy + text_yy + 1, "/");



	//draw total civilians
	draw_set_color(_col);
	draw_text(xx + text_xx + 15, yy + text_yy + 1, o_game.civilians);
	//draw_text(xx + text_xx, yy + text_yy, o_game.civilians);
}else {
	var text_xx = 7;
	var text_yy = 22;
	draw_set_color(_col);
	draw_text(xx + text_xx + 1, yy + text_yy + 1, o_game.chest_collected);
	...
	//draw total civilians
	draw_set_color(_col);
	draw_text(xx + text_xx + 15, yy + text_yy + 1, o_game.chests);
	//draw_text(xx + text_xx, yy + text_yy, o_game.civilians);
}
#endregion
if room!=rm_game_end{
...
#region
	...
	draw_text(xx + text_xx + 46, yy + text_yy + 1, score);
	//draw text
	draw_set_color(_col);
	draw_text(xx + text_xx+45, yy + text_yy, score);
	#endregion
//lives
#region
xx = 48;
...
//game over
	...
	if game_over_lose or (game_over_won and game_over_won_delay <= 0) {
		...
		if game_over_lose var _index = 0 else var _index = 1;
 		draw_sprite(s_game_over_text, _index, mx-130, my-40);
		...
		text[0] = string(o_player.civilian_value) + " x";
		text[1] = o_game.civilians_freed;
		var _gems_total = o_game.civilians_freed * o_player.civilian_value;
		text[2] = _gems_total;
